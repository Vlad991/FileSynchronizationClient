...
public enum ClientStatus {
    ...
    CLIETNT_WORK("CLIENT_WORK"), // works in normal mode (sends or receives files)
    CLIENT_ARCHIVE("CLIENT_ARCHIVE"); // not logged in clients (server rejected connection), or its work is done
